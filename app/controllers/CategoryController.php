...
class CategoryController extends AppController {
    ...
    public function viewAction(){
        ...
        $main_category_title = Breadcrumbs::getMainCategoryTitle($category->id);
        $show_filters = $main_category_title == 'Смартфоны';

        $this->setMeta($category->title, $category->description, $category->keywords);
        $this->set(compact('products', 'breadcrumbs', 'pagination', 'total', 'show_filters'));
    }
