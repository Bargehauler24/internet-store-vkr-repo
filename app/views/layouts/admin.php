...
<head>
    ...
    <base href="/adminlte/">
    <link rel="shortcut icon" href="<?=PATH;?>/images/7ok.png" type="image/png" />
    <?=$this->getMeta();?>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=PATH;?>" class="logo" target="_blank">
            <span class="logo-mini"><b>A</b>7s</span>
            <span class="logo-lg"><b>Admin</b> 7sotok.ru</span>
        </a>
...
<i class="fa fa-angle-left pull-right"></i>
    ...
    <footer class="main-footer">
        ...
        <strong> &copy; 2020 <a href="https://vk.com/id35966506">Илья Бурлаченков</a>.</strong> Все права защещины.
    </footer>
